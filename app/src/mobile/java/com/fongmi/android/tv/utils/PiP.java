package com.Mbox.android.tv.utils;
...
import com.Mbox.android.tv.event.ActionEvent;
import com.Mbox.android.tv.receiver.ActionReceiver;
...
public class PiP {
    ...
    public void update(Activity activity, boolean play) {
        try {
            ...
            actions.add(buildRemoteAction(activity, com.Mbox.android.tv.R.drawable.ic_action_audio, R.string.exo_controls_hide, ActionEvent.AUDIO));
